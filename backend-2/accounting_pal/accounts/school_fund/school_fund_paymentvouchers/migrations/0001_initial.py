    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('operation_receipt', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='school_fund_voucher', to='operations_receipts.operationreceipt')),
            ],
        ),
    ]
