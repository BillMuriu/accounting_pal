...
# Function to get school fund tuition debits
def get_school_fund_tuition_debits(start_date, end_date):
    debits = []
    ...
    # Fetch Payment Vouchers within the specified period where vote_head is 'tuition'
    payment_vouchers = SchoolFundPaymentVoucher.objects.filter(date__gte=start_date, date__lt=end_date, vote_head='tuition')
...
# Function to get school fund tuition credits
def get_school_fund_tuition_credits(start_date, end_date):
    credits = []
    ...
    # Fetch Operation Receipts within the specified period where received_from is 'tuition'
    operation_receipts = SchoolFundReceipt.objects.filter(date__gte=start_date, date__lt=end_date, received_from='tuition')
...
# Function to get school fund tuition ledger with debits and credits
def get_school_fund_tuition_ledger(start_date, end_date):
    # Get debits and credits
    debits = get_school_fund_tuition_debits(start_date, end_date)
    credits = get_school_fund_tuition_credits(start_date, end_date)
