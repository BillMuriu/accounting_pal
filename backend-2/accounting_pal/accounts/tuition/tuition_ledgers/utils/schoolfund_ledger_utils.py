...
def get_school_fund_debits(start_date, end_date):
    debits = []
    ...
    # Fetch Payment Vouchers within the specified period where vote_head is 'school_fund'
    payment_vouchers = TuitionPaymentVoucher.objects.filter(date__gte=start_date, date__lt=end_date, vote_head='school_fund')
...
def get_school_fund_credits(start_date, end_date):
    credits = []
    ...
    # Fetch Operation Receipts within the specified period where received_from is 'school_fund'
    operation_receipts = TuitionReceipt.objects.filter(date__gte=start_date, date__lt=end_date, received_from='school_fund')
...
def get_school_fund_ledger(start_date, end_date):
    # Get debits and credits
    debits = get_school_fund_debits(start_date, end_date)
    credits = get_school_fund_credits(start_date, end_date)
