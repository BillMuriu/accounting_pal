...
from .utils.balances_utils import calculate_balances
from .utils.create_trial_balance_utils import create_trial_balance
...
class TrialBalanceView(APIView):
    def get(self, request):
        ...
        try:
            trial_balance = create_trial_balance(start_date, end_date)
