...
def get_school_fund_debits(start_date, end_date):
    ...
    payment_vouchers = PaymentVoucher.objects.filter(date__gte=start_date, date__lt=end_date, vote_head='school_fund')
...
def get_school_fund_credits(start_date, end_date):
    ...
    operation_receipts = OperationReceipt.objects.filter(date__gte=start_date, date__lt=end_date, received_from='school_fund')
