...
from .cashbook_utils import get_rmi_payments_money_out, get_rmi_receipts_money_in, get_rmi_cashbook

class RMIPaymentsMoneyOutView(APIView):
    def get(self, request, *args, **kwargs):
        ...
        try:
            ...
            payments_data = get_rmi_payments_money_out(year, month)
...
class RMIReceiptsMoneyInView(APIView):
    def get(self, request):
        ...
        try:
            ...
            receipts_data = get_rmi_receipts_money_in(year, month)
...
class RMICashbookView(APIView):
    def get(self, request, *args, **kwargs):
        ...
        try:
            ...
            cashbook_data = get_rmi_cashbook(year, month)
